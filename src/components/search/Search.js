                                            ...
                                            {!loading ? (
                                                <Fragment>
                                                    ...
                                                    {currentData && currentData.length > 0 && (
                                                        <Link href={`${catalogPath}?search=${encodeURIComponent(query)}`}>
                                                            <button
                                                                type="button"
                                                                onClick={() => {
                                                                    useSearchbar.setState({ Isopen: false });
                                                                ...
                                                                className="flex w-full items-center justify-center gap-2 py-4 bg-white text-black font-semibold hover:bg-white/90 transition-colors"
                                                            >
