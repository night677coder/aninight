...
export function VideoLayout({ groupedEp, thumbnails, subtitles }: VideoLayoutProps) {
  return (
    <>
      ...
      >
        <Controls.Group className="flex justify-between items-center w-full px-1 pt-1 relative z-30">
          <div className='flex sm:hidden items-center justify-between w-full relative z-30'>
          <div className="relative z-30 pointer-events-auto">
            <Buttons.ChromeCast tooltipPlacement='top'/>
          </div>
          <div className='flex-1'></div>
          <div className="flex sm:hidden items-center relative z-30 pointer-events-auto">
            {subtitles?.length>0 && (
