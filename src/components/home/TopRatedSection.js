    ...
    <div className={styles.topRatedSection}>
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <h2 className={styles.title}>Top Rated Anime</h2>
              ...
              <Link href={`/anime/info/${anime.id}`} key={anime.id} className={styles.card}>
                <div className={styles.cardInner}>
                  <div className={styles.imageContainer}>
                    ...
                    <div className={`${styles.scoreBadge} ${index < 3 ? styles.scoreBadgeTop : styles.scoreBadgeRegular}`}>
                      <FontAwesomeIcon icon={index < 3 ? faAward : faStar} style={{ color: index < 3 ? 'white' : '#fbbf24' }} />
